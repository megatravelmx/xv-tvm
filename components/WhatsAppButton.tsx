...
export default function WhatsAppButton() {
  const href = buildWhatsAppLink(
    "¡Hola! Quiero información sobre los viajes de quinceañeras de Travelium ✨"
  );
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition hover:scale-105 sm:bottom-7 sm:right-7"
    >
